...
#'
#' @export
getSmoothEndoEffects <- function(reh, endo_effects, endo_memory_pars, n_cores) {
    .Call('_bremory_getSmoothEndoEffects', PACKAGE = 'bremory', reh, endo_effects, endo_memory_pars, n_cores)
}
...
#'
#' @export
nllik <- function(pars, stats, event_binary, interevent_time, n_cores) {
    .Call('_bremory_nllik', PACKAGE = 'bremory', pars, stats, event_binary, interevent_time, n_cores)
}
...
#'
#' @export
performBSIR <- function(nsim, mean, sigma, df, stats, event_binary, interevent_time, n_cores) {
    .Call('_bremory_performBSIR', PACKAGE = 'bremory', nsim, mean, sigma, df, stats, event_binary, interevent_time, n_cores)
}
