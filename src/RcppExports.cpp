...
RcppExport SEXP _bremory_getRiskset(SEXP actors_idSEXP, SEXP NSEXP, SEXP selfedgesSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(getRiskset(actors_id, N, selfedges));
    return rcpp_result_gen;
END_RCPP
}
// getRisksetMatrix
arma::umat getRisksetMatrix(arma::mat riskset, arma::uword N);
RcppExport SEXP _bremory_getRisksetMatrix(SEXP risksetSEXP, SEXP NSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type riskset(risksetSEXP);
    Rcpp::traits::input_parameter< arma::uword >::type N(NSEXP);
    rcpp_result_gen = Rcpp::wrap(getRisksetMatrix(riskset, N));
    return rcpp_result_gen;
END_RCPP
}
// getBinaryREH
...
// updateEndoEffects
arma::vec updateEndoEffects(std::vector<std::string> effects, Rcpp::List beta_endo, Rcpp::Environment binaryREH, arma::vec elapsed_time, arma::mat edgelist, arma::umat riskset, arma::umat riskset_matrix, arma::uword N, arma::uword M_partial);
RcppExport SEXP _bremory_updateEndoEffects(SEXP effectsSEXP, SEXP beta_endoSEXP, SEXP binaryREHSEXP, SEXP elapsed_timeSEXP, SEXP edgelistSEXP, SEXP risksetSEXP, SEXP riskset_matrixSEXP, SEXP NSEXP, SEXP M_partialSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::vector<std::string> >::type effects(effectsSEXP);
    Rcpp::traits::input_parameter< Rcpp::List >::type beta_endo(beta_endoSEXP);
    Rcpp::traits::input_parameter< Rcpp::Environment >::type binaryREH(binaryREHSEXP);
    Rcpp::traits::input_parameter< arma::vec >::type elapsed_time(elapsed_timeSEXP);
    Rcpp::traits::input_parameter< arma::mat >::type edgelist(edgelistSEXP);
    Rcpp::traits::input_parameter< arma::umat >::type riskset(risksetSEXP);
    Rcpp::traits::input_parameter< arma::umat >::type riskset_matrix(riskset_matrixSEXP);
    Rcpp::traits::input_parameter< arma::uword >::type N(NSEXP);
    Rcpp::traits::input_parameter< arma::uword >::type M_partial(M_partialSEXP);
    rcpp_result_gen = Rcpp::wrap(updateEndoEffects(effects, beta_endo, binaryREH, elapsed_time, edgelist, riskset, riskset_matrix, N, M_partial));
    return rcpp_result_gen;
END_RCPP
}
// stepwiseWeight
...
static const R_CallMethodDef CallEntries[] = {
    {"_bremory_getRiskset", (DL_FUNC) &_bremory_getRiskset, 3},
    {"_bremory_getRisksetMatrix", (DL_FUNC) &_bremory_getRisksetMatrix, 2},
    ...
    {"_bremory_updateEndoEffects", (DL_FUNC) &_bremory_updateEndoEffects, 9},
